...
def main():
    ...
    model = load_model_from_path("E:/zju/desktop_organization/functional grasp/frame_work/assets/sence.xml")
    sim = MjSim(model)
    # viewer set up
    viewer = MjViewer(sim)
    hand = Controller(sim)
    ...
    for i in range(2000):
        ...
        hand.apply_torque(hand.xr_joint_id, hand.xr_ac_id, data[3] - 0.00075 * i, 0)
        hand.apply_torque(hand.yr_joint_id, hand.yr_ac_id, data[4], 0)
        hand.apply_torque(hand.zr_joint_id, hand.zr_ac_id, data[5], 0)
    ...
    for i in range(2000):
        hand.apply_torque(hand.xs_joint_id, hand.xs_ac_id, data[0], 0)
        hand.apply_torque(hand.ys_joint_id, hand.ys_ac_id, data[1] + 0.1, 0)
        # hand.apply_torque(hand.zs_joint_id, hand.zs_ac_id, data[2] + 0.2 - 0.0001 * i, 0)
        hand.apply_torque(hand.xr_joint_id, hand.xr_ac_id, data[3] - 1.5, 0)
        hand.apply_torque(hand.yr_joint_id, hand.yr_ac_id, data[4], 0)
        hand.apply_torque(hand.zr_joint_id, hand.zr_ac_id, data[5], 0)
        hand.apply_torque(hand.ff_joint_id, hand.ff_ac_id, data[6] - data[6] / 1999 *i, 0, fd_torque= 0)
        hand.apply_torque(hand.mf_joint_id, hand.mf_ac_id, data[7]- data[7] / 1999 *i, 0, fd_torque= 0)
        hand.apply_torque(hand.rf_joint_id, hand.rf_ac_id, data[8]- data[8] / 1999 *i, 0, fd_torque= 0)
        hand.apply_torque(hand.lf_joint_id, hand.lf_ac_id, data[9]- data[9] / 1999 *i, 0, fd_torque= 0)
        hand.apply_torque(hand.th2_joint_id, hand.th2_ac_id, data[10], 0)
        hand.apply_torque(hand.th1_joint_id, hand.th1_ac_id, data[11], 0, fd_torque= 0)
        sim.step()
        viewer.render()
    ...
    for i in range(200000):
        hand.apply_torque(hand.zs_joint_id, hand.zs_ac_id, data[2] + 0.11 + 0.0001 * i, 0, kp=10000)
        hand.apply_torque(hand.xs_joint_id, hand.xs_ac_id, data[0], 0)
        hand.apply_torque(hand.ys_joint_id, hand.ys_ac_id, data[1], 0)
        # hand.apply_torque(hand.zs_joint_id, hand.zs_ac_id, data[2] + 0.2 - 0.0001 * i, 0)
        hand.apply_torque(hand.xr_joint_id, hand.xr_ac_id, data[3] - 1.5, 0)
        ...
        hand.apply_torque(hand.ff_joint_id, hand.ff_ac_id, 0, 0, fd_torque= 0)
        hand.apply_torque(hand.mf_joint_id, hand.mf_ac_id, 0, 0, fd_torque= 0)
        hand.apply_torque(hand.rf_joint_id, hand.rf_ac_id, 0, 0, fd_torque= 0)
        hand.apply_torque(hand.lf_joint_id, hand.lf_ac_id, 0, 0, fd_torque= 0)
        hand.apply_torque(hand.th2_joint_id, hand.th2_ac_id, 0, 0)
        hand.apply_torque(hand.th1_joint_id, hand.th1_ac_id, 0, 0, fd_torque= 0)
    ...
    #     sim.data.qpos[0:len(key_qpos)] = key_qpos.copy()
    #     sim.step()
    #     viewer.render()
