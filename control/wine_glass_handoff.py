...
def main():
    data = np.load("functional grasp/data/wine_glass/data_for_hand_off.npy")
    print(data)
    model = load_model_from_path("E:/zju/desktop_organization/functional grasp/assets/wine_glass_handoff.xml")
    sim = MjSim(model)
    # viewer set up
    viewer = MjViewer(sim)
    hand = Controller(sim)
    ...
    for i in range(1000):
        hand.apply_torque(hand.xs_joint_id, hand.xs_ac_id, -0.10552161, 0)
        hand.apply_torque(hand.ys_joint_id, hand.ys_ac_id, -0.02332428 , 0)
        hand.apply_torque(hand.zs_joint_id, hand.zs_ac_id, 0.09108809, 0, kp=10000)        
        hand.apply_torque(hand.xr_joint_id, hand.xr_ac_id, 0.093, 0)
        hand.apply_torque(hand.yr_joint_id, hand.yr_ac_id, 2.04823581, 0)
        hand.apply_torque(hand.zr_joint_id, hand.zr_ac_id, -0.00754898, 0)
    ...
    for i in range(niter + 1):
        hand.apply_torque(hand.xs_joint_id, hand.xs_ac_id, -0.10552161 + (data[0] + 0.10552161) / niter * i, 0)      
        hand.apply_torque(hand.ys_joint_id, hand.ys_ac_id, -0.02332428 + (data[1] + 0.02332428) / niter * i, 0)
        hand.apply_torque(hand.zs_joint_id, hand.zs_ac_id, 0.09108809 + (data[2] - 0.09108809) / niter * i, 0, kp=10000)
        hand.apply_torque(hand.xr_joint_id, hand.xr_ac_id, 0.093 + (data[3] - 0.093)/ niter * i, 0)
        hand.apply_torque(hand.yr_joint_id, hand.yr_ac_id, 2.04823581 + (data[4] - 2.04823581 )/ niter * i, 0, kp=1000)
        hand.apply_torque(hand.zr_joint_id, hand.zr_ac_id, (data[5] - 0)/ niter * i, 0)
