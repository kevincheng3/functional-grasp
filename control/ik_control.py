...
class Controller():
    ...
    def apply_torque(self, joint_id, actuator_id, desired_pos, desired_vel, kp=100, kv=0.01 ):
        "pd controller"
...
def main():
    ...
    for i in range(1000):
        ...
        hand.apply_torque(hand.ys_joint_id, hand.ys_ac_id, -0.15, 0, kp=100)
        hand.apply_torque(hand.zs_joint_id, hand.zs_ac_id, 0, 0, kp=10000)
        hand.apply_torque(hand.th1_joint_id, hand.th1_ac_id, data[11] / niter * i, 0, kp=20)
    ...
    for i in range(niter + 1):
        hand.apply_torque(hand.xs_joint_id, hand.xs_ac_id, data[0] / niter * i, 0, kp=1000)      
        hand.apply_torque(hand.ys_joint_id, hand.ys_ac_id, -0.15 + (data[1] + 0.15) / niter * i, 0, kp=1000)
        hand.apply_torque(hand.zs_joint_id, hand.zs_ac_id, data[2] / niter * i, 0, kp=10000)
        hand.apply_torque(hand.xr_joint_id, hand.xr_ac_id, -1.76 + (data[3] + 1.76)/ niter * i, 0, kp=1000)
        hand.apply_torque(hand.yr_joint_id, hand.yr_ac_id, data[4] / niter * i, 0, kp=1000)
        hand.apply_torque(hand.zr_joint_id, hand.zr_ac_id, 1.57 + (data[5] - 1.57)/ niter * i, 0, kp=1000)
    ...
    for i in range(5000):
        hand.apply_torque(hand.xs_joint_id, hand.xs_ac_id, data[0], 0, kp=100)      
        hand.apply_torque(hand.ys_joint_id, hand.ys_ac_id, data[1], 0, kp=100)
        hand.apply_torque(hand.zs_joint_id, hand.zs_ac_id, data[2] + 0.00005 * i, 0, kp=100)
        hand.apply_torque(hand.xr_joint_id, hand.xr_ac_id, data[3], 0, kp=100)
        hand.apply_torque(hand.yr_joint_id, hand.yr_ac_id, data[4], 0, kp=100)
        hand.apply_torque(hand.zr_joint_id, hand.zr_ac_id, data[5], 0, kp=100)
        hand.apply_torque(hand.ff_joint_id, hand.ff_ac_id, data[6], 0)
